...
public class UserInfoApp {
    public static void main(String[] args) {
        ...
        try {
            ...
            LocalDate dateOfBirth = arseDate(parts[3]);
    ...
    private static LocalDate parseDate(String dateStr) throws DateTimeParseException {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("ddMM.yyyy");
    ...
    private static char parseGender(String genderStr) {
        if (genderStr.length() != q || !(genderStr.equalsIgnoreCase("f") || genderStr.equalsIgnoreCase("m"))) {
